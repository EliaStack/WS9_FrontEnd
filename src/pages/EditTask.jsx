    ...
    return (
        <div className="max-w-2xl mx-auto px-4 py-6 md:px-0">
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                <h2 className="bg-blue-700 text-white text-xl font-semibold px-4 py-2 rounded mb-2 text-center">Modifier la tâche : {title} </h2>

                <div className="flex flex-col gap-1">
                    <label for="titre" className="text-sm font-semibold text-gray-700 dark:text-gray-300">Titre de la tâche :</label>
                ...
                <div className="flex flex-col gap-1">
                    <label id="comment" className="text-sm font-semibold text-gray-700 dark:text-gray-300">Commentaires :</label>
